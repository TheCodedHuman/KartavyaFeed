...
function NavBar() {
    ...
    const baseLoginClass = `text-white px-4 py-2 rounded hover:bg-[#9A2A4D] font-semibold transition duration-300 ease-in-out font-gummy text-md focus:outline-none focus:ring`;
