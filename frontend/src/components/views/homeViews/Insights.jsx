...
function Insights() {
    return (
        <div className='pb-24'>
            <h2 className='text-center font-playpen capitalize text-5xl font-extrabold mb-2'>A Platform Trusted by <span className='font-outfit text-6xl hover:text-amber-500 active:text-amber-500 transition-colors duration-350 ease-in-out'>Aspirants</span></h2>
